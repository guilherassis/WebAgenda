...
$.extend($.validator, {
	...
	messages: {
		...
		email: "Por favor, digite um endere&ccedil;o v&aacute;lido de email.",
		...
		maxlength: $.format("Por favor, n&atilde;o digite mais que {0} caracteres."),
		minlength: $.format("Por favor, digite ao menos {0} caracteres."),
